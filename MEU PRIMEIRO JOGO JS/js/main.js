...
function start() { // Inicio da funçao start()
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> o império venceu! :( </h1><p>Sua pontuaçao foi: " + pontos + "</p><p>Recorde: " + maiorPontuacao + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Jogar Novamente</h3></div>");
    ...
    function venceu() {
        ...
        $("#fim").html("<h1> A galaxia foi salva! Parabens!</h1><p>Sua pontuaçao foi: " + pontos + "</p><p>Recorde: " + maiorPontuacao + "</p><p>Tire um print e me marca no tt @oi_gummy</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Jogar Novamente</h3></div>");
